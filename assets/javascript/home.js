...
function displayPhotographers (photographers) {
    const photographersContainer = document.querySelector('#photographers-grid')
    for (let index = 0; index < photographers.length; index++) {
        ...
        const tagsContainer = document.querySelector('#photographer-tags-' + photographers[index].id)
...
function displayPhotographersByTags (id) {
    const photographers = listOfphotographers
    for (let index = 0; index < photographers.length; index++) {
        const tagsContent = photographers[index].tags
        const photographer = document.getElementById(photographers[index].id)
